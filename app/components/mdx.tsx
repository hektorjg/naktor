...
const components = {
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={clsx(
        'mt-10 scroll-m-20 border-b border-b-zinc-800 pb-1 font-semibold text-3xl tracking-tight first:mt-0',
        className
      )}
      {...props}
    />
  ...
  blockquote: ({ className, ...props }) => (
    <blockquote
      className={clsx(
        'mt-6 border-zinc-300 border-l-2 pl-6 text-zinc-800 italic [&>*]:text-zinc-600',
        className
      )}
      {...props}
    />
  ...
  tr: ({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) => (
    <tr
      className={clsx(
        'm-0 border-zinc-300 border-t p-0 even:bg-zinc-100',
        className
      )}
      {...props}
    />
